...
public class Admin_borrowmark {
	...
	protected void createContents() {
		...
		table.setBounds(10, 180, 1119, 458);
		...
		lblNewLabel.setBounds(397, 53, 266, 48);

		Label icon = new Label(shell, SWT.NONE);
		icon.setImage(SWTResourceManager.getImage(Admin_borrowmark.class, "/images/MC.ico"));
		icon.setBounds(203, 10, 128, 152);

		Bookborrow borrow = new Bookborrow();
		String borr[][] = borrow.ShowAllBorrow();
		if (borr.length != 1) {
