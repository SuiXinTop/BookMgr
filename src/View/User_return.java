...
public class User_return {
	...
	protected void createContents() {
		...
		text_账号.setText(id);
		text_账号.setBounds(447, 204, 156, 26);
		...
		text_借书日期 = new Text(shell, SWT.BORDER);
		text_借书日期.setFont(SWTResourceManager.getFont("楷体", 12, SWT.NORMAL));
		text_借书日期.setBounds(447, 363, 156, 26);
